...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addNumEntry("depth", &fEntry3, 1.0f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addNumEntry("dmax", &fEntry1, 10.0f, 0.0f, 15.0f, 0.00999999978f);
		ui_interface->addNumEntry("fb", &fEntry0, 0.0f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addNumEntry("invert", &fEntry2, 0.0f, 0.0f, 1.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow3 = (0.00100000005f * float(fEntry3));
		for (int i = 0; (i < count); i = (i + 1)) {
			fRec1[0] = (fSlow0 + (0.999000013f * fRec1[1]));
			float fTemp0 = float(input0[i]);
			fVec0[0] = ((fRec0[1] * fRec1[0]) - fTemp0);
			fRec2[0] = (fSlow1 + (0.999000013f * fRec2[1]));
			fRec0[0] = fVec0[int(float((10 & int((fRec2[0] + -1.0f)))))];
			fRec3[0] = (fSlow2 + (0.999000013f * fRec3[1]));
			fRec4[0] = (fSlow3 + (0.999000013f * fRec4[1]));
			output0[i] = FAUSTFLOAT((0.5f * ((fRec0[0] * (int(fRec3[0])?(0.0f - fRec4[0]):fRec4[0])) + fTemp0)));
			fRec1[1] = fRec1[0];
